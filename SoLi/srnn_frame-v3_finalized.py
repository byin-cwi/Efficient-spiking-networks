...
########################################################################
####################################################300
# train_x = np.load('./data_set_ch/train_x_ch3.npy')/255.
# train_y = np.load('./data_set_ch/train_y_ch3.npy')
# # plt.hist(train_y)

# valid_x = np.load('./data_set_ch/valid_x_ch3.npy')/255.
# valid_y = np.load('./data_set_ch/valid_y_ch3.npy')
